[![travis](https://travis-ci.org/Yimonchen/biodemo.svg?branch=master)](https://travis-ci.org/Yimonchen/biodemo)
...
This program is released as open source software under the terms of [MIT License](https://raw.githubusercontent.com/Yimonchen/biodemo/master/LICENSE).

# Installing

Clone this repository: 
```
$ git clone https://github.com/Yimonchen/biodemo
```
...
[biodemo issue tracker](https://github.com/Yimonchen/biodemo/issues)
